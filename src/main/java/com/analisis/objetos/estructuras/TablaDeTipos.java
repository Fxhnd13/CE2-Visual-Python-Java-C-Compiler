...
public class TablaDeTipos {
    ...
    public Dato verificarTiposDeOperacionAritmetica(int operacion, Dato izquierdo, Dato derecho, Coleccion coleccion){
        ...
        switch(operacion){
            ...
            case 3: dato = verificarTiposSuma(izquierdo, derecho, coleccion); break;
            case 4: dato = verificarTiposResta(izquierdo, derecho, coleccion); break;
        }
        return dato;
    }
    ...
    private Dato verificarTiposSuma(Dato izquierdo, Dato derecho, Coleccion coleccion) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Dato verificarTiposResta(Dato izquierdo, Dato derecho, Coleccion coleccion) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
