...
/**
 * Clase destinada al almacenamiento de la informacion de un nodo menos y el manejo del mismo
 * @author jose_
 */
public class Menos implements NodoAritmetico{
    ...
    public Menos(NodoAritmetico izquierdo, NodoAritmetico derecho, Pos posicion) {
    ...
    public Dato analizarSemanticamente(Coleccion coleccion) {
        ...
        Dato dato = tablaDeTipos.verificarTiposDeOperacionAritmetica(4, izquierdo, derecho, coleccion);
