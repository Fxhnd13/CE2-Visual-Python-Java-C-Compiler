...
/**
 * Clase destinada al almacenamiento de la informacion de un nodo Division y el manejo del mismo
 * @author jose_
 */
public class Div implements NodoAritmetico{
    ...
    public Div(NodoAritmetico izquierdo, NodoAritmetico derecho, Pos posicion) {
    ...
    public Dato analizarSemanticamente(Coleccion coleccion) {
        ...
        Dato dato = tablaDeTipos.verificarTiposDeOperacionAritmetica(1, izquierdo, derecho, coleccion);
